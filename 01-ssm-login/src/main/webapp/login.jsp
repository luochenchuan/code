...
<body>
    ...
    <div class="login-form">
        ...
        <form action="/login/login.html" method="post">
            ...
            <input type="text" class="text" name="userName" placeholder="Username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" >
    ...
    <div class="copy-rights">
        <p>Copyright &copy; 2015.Company <a href="javascript:;">zhu</a></p>
    </div>
